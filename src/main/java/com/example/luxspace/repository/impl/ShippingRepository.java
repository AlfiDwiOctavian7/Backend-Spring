...
public class ShippingRepository implements IShippingRepository{
	...
	public Student insertStudent(Student student) {
		...
		jdbcTemplate.update(query, new Object[] {student.getStudent_name(), student.getStudent_age(), student.getStudent_email(),
				student.getGender(),student.getHard_skill(), student.getShoft_skill(),  student.getInterest(), student.getSelf_description() });
		return student;
	}
	...
	public Student updateStudent(int id, Student student) {
		...
		jdbcTemplate.update(query, new Object[] {student.getStudent_name(), student.getShoft_skill(), student.getStudent_age(),student.getGender(), 
				student.getHard_skill(), student.getStudent_email(),
				  student.getInterest(), student.getSelf_description(), id });
